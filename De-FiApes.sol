...
contract DeFiApes is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x7EAbDDfB617Aed7eaFef579c21317A24eD2d0567); // Marketing Address
        
    address payable public teamAddress =
        payable(0x4Da2D4223f0724C3085e4413c3bc34bE97bA69a4); // Team Address
    ...
    string private constant _name = "De-Fi Apes";
